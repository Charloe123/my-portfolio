...
export default function TwoButtons() {
  return (
    <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-6">
      ...
      <button
        className="flex items-center justify-center gap-2 sm:gap-2.5 px-6 py-3 sm:px-8 sm:py-3 w-full sm:w-auto bg-cyan-400 hover:bg-cyan-300 text-gray-900 rounded-full font-semibold transition-transform duration-200 transform hover:scale-105"
